 ...
 * @test
 */
BOOST_AUTO_TEST_CASE(test_cache_new)
{
    f2fs("test/data/test.fa", "tmp/test_cachce_test.b.fastafs");
/*
...
{
    // generate FASTAFS file from FASTA file
    fasta_to_fastafs f = fasta_to_fastafs("test", "test/data/test_003.fa");
    f.cache();
    f.write("tmp/test_cachce_test_003.fastafs");
