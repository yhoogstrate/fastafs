...
public:
    ...
    uint32_t view_sequence_region_size(ffs2f_init_seq*, sequence_region*,  off_t, std::ifstream *);
...
public:
    ...
    uint32_t view_sequence_region_size(ffs2f_init*, const char *, off_t); // read stuff like "chr1:123-456" into the buffer
